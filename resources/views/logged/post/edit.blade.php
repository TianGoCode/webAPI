                ...
                <div class="posts-body">
                    <div class="posts-edit">
                        <form action="/edit_post" method="post">
                            @csrf
                            <textarea class="form-control" name="described" rows="3">{{  $post->described  }}</textarea>
                            <input type="file" name="image">
                            <input type="file" name="video">
                            <input type="hidden" name="status">
                            <input type="hidden" name="token" value="{{ session()->get('token') }}">
                            <input type="hidden" name="id" value="{{ $post->id }}">
                            <input type="hidden" name="image_sort">
                            <input type="hidden" name="thump">
                            <input type="hidden" name="auto_block">
                            <input type="hidden" name="auto_accept">
